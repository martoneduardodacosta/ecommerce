...
<div class="login-box">
  ...
  <div class="login-box-body">
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input type="checkbox"> Arquivar Senha
            </label>
          </div>
        </div>
        <!-- /.col -->
    ...
    <div class="social-auth-links text-center">
      <p>- OU -</p>
      <a href="#" class="btn btn-block btn-social btn-facebook btn-flat"><i class="fa fa-facebook"></i> Acessar com
        Facebook</a>
      <a href="#" class="btn btn-block btn-social btn-google btn-flat"><i class="fa fa-google-plus"></i> Acessar com
        Google+</a>
    </div>
    <!-- /.social-auth-links -->
